...
a = pygame.transform.scale(a, fullscreen_image_size)#Author: FunnybunnyofDOOM
#Created: 9/24/2021
#Language: Python 3.0
#Contact: Funnybunnyofdoom@gmail.com
...
#Check for display status of images
    if display_q == True:
        ...
        screen.blit(q, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "q.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(w, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "w.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(e, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "e.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(r, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "r.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(t, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "t.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_y == True:
        screen.fill(background_colour)
        screen.blit(y, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "y.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_u == True:
        screen.fill(background_colour)
        screen.blit(u, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "u.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_i == True:
        screen.fill(background_colour)
        screen.blit(i, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "i.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_o == True:
        screen.fill(background_colour)
        screen.blit(o, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "o.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_p == True:
        screen.fill(background_colour)
        screen.blit(p, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "p.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_a == True:
        screen.fill(background_colour)
        screen.blit(a, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "a.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_s == True:
        screen.fill(background_colour)
        screen.blit(s, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "s.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_d == True:
        screen.fill(background_colour)
        screen.blit(d, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "d.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_f == True:
        screen.fill(background_colour)
        screen.blit(f, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "f.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_g == True:
        screen.fill(background_colour)
        screen.blit(g, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "g.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_h == True:
        screen.fill(background_colour)
        screen.blit(h, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "h.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_j == True:
        screen.fill(background_colour)
        screen.blit(j, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "j.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_k == True:
        screen.fill(background_colour)
        screen.blit(k, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "k.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_l == True:
        screen.fill(background_colour)
        screen.blit(l, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "l.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_z == True:
        screen.fill(background_colour)
        screen.blit(z, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "z.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_x == True:
        screen.fill(background_colour)
        screen.blit(x, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "x.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_c == True:
        screen.fill(background_colour)
        screen.blit(c, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "c.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_v == True:
        screen.fill(background_colour)
        screen.blit(v, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "v.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_b == True:
        screen.fill(background_colour)
        screen.blit(b, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "b.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_n == True:
        screen.fill(background_colour)
        screen.blit(n, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "n.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_m == True:
        screen.fill(background_colour)
        screen.blit(m, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "m.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_0 == True:
        screen.fill(background_colour)
        screen.blit(k0, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "0.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_9 == True:
        screen.fill(background_colour)
        screen.blit(k9, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "9.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_8 == True:
        screen.fill(background_colour)
        screen.blit(k8, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "8.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_7 == True:
        screen.fill(background_colour)
        screen.blit(k7, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "7.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_6 == True:
        screen.fill(background_colour)
        screen.blit(k6, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "6.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_5 == True:
        screen.fill(background_colour)
        screen.blit(k5, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "5.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_4 == True:
        screen.fill(background_colour)
        screen.blit(k4, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "4.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_3 == True:
        screen.fill(background_colour)
        screen.blit(k3, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "3.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_2 == True:
        screen.fill(background_colour)
        screen.blit(k2, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "2.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    elif display_1 == True:
        screen.fill(background_colour)
        screen.blit(k1, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "1.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(alt, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "alt.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "backspace.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "caplock.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "shift.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "ctrl.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "delete.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "down.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(end, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "end.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "enter.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "home.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "insert.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "left.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "printscreen.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "right.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "space.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(tab, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "tab.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "symbols.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
        ...
        screen.blit(up, (0, 0))
        pygame.display.update()
        mixer.music.load(os.path.join(sfx_path, "up.mp3"))
        mixer.music.set_volume(0.4)
        mixer.music.play()
    else:
        screen.fill(background_colour)
